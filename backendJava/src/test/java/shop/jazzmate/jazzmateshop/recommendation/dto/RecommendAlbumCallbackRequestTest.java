...
class RecommendAlbumCallbackRequestTest {
    ...
    class JsonDeserialization {
        ...
        void completedCallbackJson_deserializesFields() throws Exception {
            ...
            RecommendAlbumCallbackRequest request =
                    objectMapper.readValue(json, RecommendAlbumCallbackRequest.class);
            ...
            assertThat(request.getRecommendations().get(0).getAlbumArtist()).isEqualTo("Miles Davis");
            assertThat(request.getRecommendations().get(0).getAlbumTitle()).isEqualTo("Kind of Blue");
